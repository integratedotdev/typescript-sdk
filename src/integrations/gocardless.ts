...
const logger = createLogger("GoCardless Bank Account Data");
...
export function gocardlessIntegration(config: GocardlessIntegrationConfig = {}): MCPIntegration<"gocardless"> {
  ...
  return { id: "gocardless", name: "GoCardless Bank Account Data", logoUrl: "https://wdvtnli2jn3texa6.public.blob.vercel-storage.com/gocardless.png", description: "Manage GoCardless Bank Account Data list institutions, create requisition, get requisition, get account, get balances", category: "Banking", tools: [...GOCARDLESS_TOOLS], authType: "oauth", oauth,
    async onInit() { logger.debug("GoCardless Bank Account Data integration initialized"); },
    async onAfterConnect() { logger.debug("GoCardless Bank Account Data integration connected"); },
  };
}
