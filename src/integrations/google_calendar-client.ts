 ...
 */
export interface GoogleCalendarIntegrationClient {
  /**
   * List calendars
   * 
   * @example
   * ```typescript
   * const calendars = await client.google_calendar.listCalendars({});
   * ```
   */
   ...
   * @example
   * ```typescript
   * const calendar = await client.google_calendar.getCalendar({
   *   calendarId: "primary"
   * });
   * ```
   */
   ...
   * @example
   * ```typescript
   * const events = await client.google_calendar.listEvents({
   *   calendarId: "primary",
   ...
   * @example
   * ```typescript
   * const event = await client.google_calendar.getEvent({
   *   calendarId: "primary",
   *   eventId: "event123"
   * });
   * ```
   ...
   * @example
   * ```typescript
   * const event = await client.google_calendar.createEvent({
   *   calendarId: "primary",
   ...
   * @example
   * ```typescript
   * await client.google_calendar.updateEvent({
   *   calendarId: "primary",
   *   eventId: "event123",
   ...
   * @example
   * ```typescript
   * await client.google_calendar.deleteEvent({
   *   calendarId: "primary",
   *   eventId: "event123"
   * });
   * ```
   ...
   * @example
   * ```typescript
   * const attendees = await client.google_calendar.listAttendees({
   *   calendarId: "primary",
   *   eventId: "event123"
   * });
   * ```
   ...
   * @example
   * ```typescript
   * const event = await client.google_calendar.quickAdd({
   *   calendarId: "primary",
