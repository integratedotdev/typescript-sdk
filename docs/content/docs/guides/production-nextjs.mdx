...
This guide summarizes patterns proven in production apps using integrate-sdk with Next.js App Router, Better Auth, and Vercel AI SDK.
...
Tool name normalization runs inside the SDK handler — no app-level POST wrapper required.
