...
export const { client: serverClient } = createMCPServer({
  ...
  integrations: [
    whatsappIntegration({
      scopes: ["business_management", "whatsapp_business_messaging", "whatsapp_business_management"], // Optional
...
Use `client.getEnabledTools()` to see all available WhatsApp tools.
