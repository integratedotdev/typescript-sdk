...
Add Mercury to your server configuration. This integration can read credentials from environment variables automatically:
...
const result = await client.mercury.getOrganization({
