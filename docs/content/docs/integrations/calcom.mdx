...
The following scopes are supported. Enable them on your Cal.com OAuth app based on the tools you need:
...
- **`SCHEDULE_WRITE`** - Create, edit, and delete schedules
- **`PROFILE_READ`** - View personal info
- **`PROFILE_WRITE`** - Edit personal info
- **`TEAM_PROFILE_READ`** - View teams
