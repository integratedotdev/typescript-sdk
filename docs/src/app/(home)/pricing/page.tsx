        ...
        <section className="py-20">
          <div className="container mx-auto px-6 text-center">
            ...
            <p className="mx-auto mt-4 max-w-lg text-lg text-zinc-600 dark:text-zinc-400">
              Start free, scale as you grow. All plans include the full
              integration library and MCP server.
            </p>
          </div>
        </section>
                  ...
                  <div className="space-y-6">
                    ...
                    <ul className="space-y-3 border-t border-zinc-200 pt-6 dark:border-zinc-800">
                      {plan.features.map((feature) => (
                        ...
                        >
                          <Check
                            className="mt-0.5 size-4 shrink-0 text-zinc-900 dark:text-white"
                            aria-hidden
                          />
                          <span>{feature}</span>
                        </li>
              ...
              <table className="w-full text-left text-sm">
                <thead>
                  <tr className="border-b border-zinc-200 dark:border-zinc-800">
                    <th className="pb-4 pr-4 font-semibold text-zinc-900 dark:text-white">
                      Provider
                    </th>
                    <th className="pb-4 pr-4 font-semibold text-zinc-900 dark:text-white">
                      Entry pricing
                    ...
                    <th className="pb-4 font-semibold text-zinc-900 dark:text-white">
                      Integrate advantage
                    </th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-zinc-200 dark:divide-zinc-800">
                  {comparisons.map((row) => (
                    <tr
                      key={row.provider}
                      className={
                        row.isPrimary ? "bg-zinc-50 dark:bg-zinc-900" : ""
                      }
                    >
                      <td className="py-4 pr-4 font-medium text-zinc-900 dark:text-white">
                        {row.provider}
                      </td>
        ...
        <section className="border-t border-zinc-200 bg-zinc-900 py-20 dark:border-zinc-800 dark:bg-black">
          <div className="container mx-auto px-6 text-center">
            ...
            <p className="mx-auto mt-4 max-w-lg text-zinc-400">
              Start building with Integrate SDK today. No credit card required
